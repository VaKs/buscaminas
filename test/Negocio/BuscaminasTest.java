...
public class BuscaminasTest {
    ...
    public void testIniciarCasillas() {
        ...
        int filas=buscaminasTest.getBloquesFila();
        int columnas = buscaminasTest.getBloquesColumna();
    ...
    public void testSetNivel() {
        ...
        buscaminasTest.setNivel(Nivel.PRINCIPIANTE);
        if(buscaminasTest.getAltoVentana()!= 300) fail("La ventana no es lo alto que debería");
        if(buscaminasTest.getAnchoVentana()!= 200) fail("La ventana no es lo ancho que debería");
        if(buscaminasTest.getBloquesColumna() != 10) fail("No hay el numero de columnas que deberia");
        if(buscaminasTest.getBloquesFila() != 10) fail("No hay el numero de filas que deberia");
        if(buscaminasTest.getCantidadCasillas()!= 100) fail("No hay el numero de casillas que deberia");
        if(buscaminasTest.getNumeroMinas()!= 10) fail("No hay el numero de minas que deberia");
        if(buscaminasTest.getBanderasRestantes()!= 10) fail("No hay el numero de banderas que deberia");
        
        System.out.println("Intermedio");
        buscaminasTest.setNivel(Nivel.INTERMEDIO);
        if(buscaminasTest.getAltoVentana()!= 416) fail("La ventana no es lo alto que debería");
        if(buscaminasTest.getAnchoVentana()!= 320) fail("La ventana no es lo ancho que debería");
        if(buscaminasTest.getBloquesColumna() != 16) fail("No hay el numero de columnas que deberia");
        if(buscaminasTest.getBloquesFila() != 16) fail("No hay el numero de filas que deberia");
        if(buscaminasTest.getCantidadCasillas()!= 256) fail("No hay el numero de casillas que deberia");
        if(buscaminasTest.getNumeroMinas()!= 70) fail("No hay el numero de minas que deberia");
        if(buscaminasTest.getBanderasRestantes()!= 70) fail("No hay el numero de banderas que deberia");
        
        System.out.println("Experto");
        buscaminasTest.setNivel(Nivel.EXPERTO);
        if(buscaminasTest.getAltoVentana()!= 520) fail("La ventana no es lo alto que debería");
        if(buscaminasTest.getAnchoVentana()!= 400) fail("La ventana no es lo ancho que debería");
        if(buscaminasTest.getBloquesColumna() != 20) fail("No hay el numero de columnas que deberia");
        if(buscaminasTest.getBloquesFila() != 20) fail("No hay el numero de filas que deberia");
        if(buscaminasTest.getCantidadCasillas()!= 400) fail("No hay el numero de casillas que deberia");
        if(buscaminasTest.getNumeroMinas()!= 150) fail("No hay el numero de minas que deberia");
        if(buscaminasTest.getBanderasRestantes()!= 150) fail("No hay el numero de banderas que deberia");
    }
    ...
    public void testReiniciarNivel() {
        ...
        int fila = buscaminasTest.getBloquesFila();
        int columna = buscaminasTest.getBloquesColumna();
        buscaminasTest.reiniciarNivel();
        Casilla casillasDespuesReinicioPrin[] = buscaminasTest.getCasillas();
        if(buscaminasTest.getNivelActual()!= Nivel.PRINCIPIANTE) fail("El nivel ha cambiado");
        if(fila != buscaminasTest.getBloquesFila()) fail("El numero de filas ha cambiado");
        if(columna != buscaminasTest.getBloquesColumna()) fail("El numero de columnas ha cambiado");
        ...
        fila = buscaminasTest.getBloquesFila();
        columna = buscaminasTest.getBloquesColumna();
        buscaminasTest.reiniciarNivel();
        Casilla casillasDespuesReinicioInt[] = buscaminasTest.getCasillas();
        if(buscaminasTest.getNivelActual()!= Nivel.INTERMEDIO) fail("El nivel ha cambiado");
        if(fila != buscaminasTest.getBloquesFila()) fail("El numero de filas ha cambiado");
        if(columna != buscaminasTest.getBloquesColumna()) fail("El numero de columnas ha cambiado");
        ...
        if(buscaminasTest.getNivelActual()!= Nivel.EXPERTO) fail("El nivel ha cambiado");
        if(fila != buscaminasTest.getBloquesFila()) fail("El numero de filas ha cambiado");
        if(columna != buscaminasTest.getBloquesColumna()) fail("El numero de columnas ha cambiado");
    ...
    public void testCompruebaGanador() {
        ...
        if(buscaminasTest.isHasGanado()) fail("hasGanado iniciado a true");
        ...
        if(!buscaminasTest.isHasGanado()) fail("No se ha ganado con el resultado correcto");
    ...
    public void testPonerQuitarBandera() {
        ...
        if(buscaminasTest.getBanderasRestantes() != banderasActuales + 1) fail("No ha aumentado las banderas");
        ...
        if(buscaminasTest.getBanderasRestantes() != banderasActuales - 1) fail("No ha restado las banderas");
        ...
        if(buscaminasTest.getBanderasRestantes() != 0) fail("ha sumado una bandera, o la ha restado");
    }
    ...
    public void testRevelarCasilla() {
        ...
        casillas = buscaminasTest.getCasillas();
        if(buscaminasTest.getBanderasRestantes() != banderasActuales + 1) fail("no ha sumado las banderas");
        ...
        casillas = buscaminasTest.getCasillas();
        if(buscaminasTest.isHasPerdido() == false) fail("no has perdido");
